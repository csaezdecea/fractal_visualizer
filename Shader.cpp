...
void Shader::use_shader(glm::vec3 coord, float option)
{
    glUseProgram(program_ID);
    //GLint myUniformLocation = glGetUniformLocation(program_ID, "ShaderVars");
    //glUniform4f(myUniformLocation, coord.x, coord.y, coord.z, option);
    glm::vec4 vecn(coord.x,coord.y,coord.z,option);
    set_vec4("ShaderVars", vecn); 
}
